  ...
  color:black;
    ...
    <body> <header align="center" class="dic"> ___________DICTIONARY___________</header>
      <aside>
        ...
        <section>
            <h1 class="heading">MEANINGS DELETE PAGE</h1>
               <?php
       $conn = mysqli_connect("localhost","root","","dict");   
        ...
        while ($row=mysqli_fetch_array($queryres)) 
        {
         ...
         <tr>
          ...
          <td><?php echo $row['SYNONYMS'];?></td>
          <td><?php echo $row['ANTONYMS'];?></td>
             <td><?php echo $row['VERB'];?></td>
              <td><?php echo $row['ADVERB'];?></td>
          <td><?php echo $row['ADJECTIVE'];?></td>
             <td><?php echo $row['NOUN'];?></td>
          
          <td>
           <button style="width:auto;" id="<?php echo $row['WORD'];?>" value="<?php echo $row['WORD'];?>"
...
{   
  ...
  <?php
        ...
        {          
            $sa=$_GET['del'];
            $conn =mysqli_connect("localhost","root","","dict");       
    $query="DELETE FROM meaning WHERE WORD='$sa'";
