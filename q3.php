            ...
            <form id="f">
                <table cellpadding="15px" border="1">
                      ...
                      <tr>
                        ...
                        <td><textarea rows="10" cols="90" id="msg"  >I_______________tennis every Sunday morning</textarea></td>
                    ...
                    <tr>
                        <td>A.<input type="checkbox" value="come to party " onclick=alert("Wrong answer") name="a" >Playing</td><br>
                    </tr>
                    <tr>
                         <td>B.<input type="checkbox" value="go to a concert " onclick=alert("Correct answer") name="b">am Playing </td><br>
                    </tr>
                    <tr>
                         <td>C.<input type="checkbox" value="give somebody a message"onclick=alert("Wrong answer") name="c" >am play</td><br>
                    </tr>
                </table>
                <input type="submit" name="submit" id="submit1" value="Submit Answer" name="submit">
                    <input type="button" name="submit" id="submit1" value="Previous" onclick="window.open('q2.php','_self');"> 
                <input type="button" name="submit" id="submit1" value="Next" onclick="window.open('q4.php','_self');"> 
