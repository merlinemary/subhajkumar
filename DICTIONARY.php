...
.container {
  ...
  color:white;
    ...
    <body>
        ...
        <section>
            <h2 class="heading">SIGN-UP PAGE</h2>
            <form id="f">
               <div class="container">
                   <br>
                   <br>
 ...
 <label for="fname" class="font">Last Name</label><br>
    <input type="text"  name="lname" placeholder="Last Name" id="lname" required><p id="err2"></p><br>

    <label for="lname"  class="font">Email-Address</label><br>
    <input type="email"  name="email" placeholder="Email Address" id="email" required><p id="err3"></p><br>
                   <label for="fname" class="font">Phone Number</label><br>
    <input type="text" name="phone" placeholder="Phone Number" id="phone" required pattern="[0-9]{10,10}"><p id="err4"></p><br>

<label for="lname"  class="font">Password</label><br>
    <input type="password"  name="pass" placeholder="Password" id="pass" required><p id="err5"></p><br>
                   <label for="fname" class="font">Confirm Password</label><br>
    <input type="password" name="cpass" placeholder="Confirm Password" id="cpass" required><p id="err6"></p><br>
    <br>
                   <br>
                   <br>
...
if(!$conn)
{
    ...
    $query ="INSERT INTO sign ( FIRSTNAME ,  LASTNAME , EMAIL, PHONENUMBER, PASSWORD, CONFIRM) VALUES ('$FIRSTNAME','$LASTNAME','$EMAIL','$PHONENUMBER','$PASSWORD','$CONFIRM')";
...
?>
    ...
    <script>
        ...
        function check_validation(){
            ...
            if(cpass.value.toString != pass.value.toString)
                {
                    document.getElementById("err6").innerHTML=cpass.validationMessage;
                }
