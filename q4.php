            ...
            <form id="f">
                <table cellpadding="15px" border="1">
                      ...
                      <tr>
                        ...
                        <td><textarea rows="10" cols="90" id="msg"  >Dont make so much noise.Shiva and kumar ________________trying to study for their ST test</textarea></td>
 
                    </tr>
                    <tr>
                        <td valign="top">Fill in the Blank from the below choice</td>
                    </tr>
                    <tr>
                        <td>A.<input type="checkbox" value="come to party " onclick=alert("Wrong answer") name="a">try</td><br>
                    </tr>
                    <tr>
                         <td>B.<input type="checkbox" value="go to a concert " onclick=alert("Correct answer") name="b">are trying</td><br>
                    </tr>
                    <tr>    
                         <td>C.<input type="checkbox" value="give somebody a message"onclick=alert("Wrong answer") name="c" >tried</td><br>
                    </tr>
                </table>
                <input type="submit" name="submit" id="submit1" value="Submit Answer" name="submit">
                    <input type="button" name="submit" id="submit1" value="Previous" onclick="window.open('q3.php','_self');"> 
                <input type="button" name="submit" id="submit1" value="Next" onclick="window.open('q5.php','_self');"> 
